...
<span class="glyphicon glyphicon-plus"></span>List a place
</a></span>
...
$result=$conn->query("Select rentroom.id, price, location, description, booking_status from rentroom , booking_details WHERE rentroom.id=booking_details.id AND rentroom.unique_id<>$unique_id AND booking_status='Not Booked'");
